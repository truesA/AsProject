...
import com.achers.mvpdemo.view.BandCardEditText;
import com.achers.mvpdemo.view.MyAnimationListener;
import com.achers.mvpdemo.view.PhoneView;
import com.achers.mvpdemo.view.StarView;
...
//        next.setOnClickListener(this);
        ...
        thirdAnim.addListener(new MyAnimationListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                View viewCode = BankCardAddActivity.this.getLayoutInflater().inflate(R.layout.view_addbank_code, null);
                ...
                Animation ivAnim = AnimationUtils.loadAnimation(BankCardAddActivity.this, R.anim.scaleanim);
                final Animation tvAnim1 = AnimationUtils.loadAnimation(BankCardAddActivity.this, R.anim.scaleanim);
                final Animation tvAnim2 = AnimationUtils.loadAnimation(BankCardAddActivity.this, R.anim.scaleanim);
